...
class AppTextFormField extends FormField<String> {
  ...
  AppTextFormField({
    ...
    EdgeInsetsGeometry? contentPadding = const EdgeInsets.symmetric(vertical: 20.0, horizontal: 20.0),
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: effectiveDecoration.copyWith(
                        enabledBorder: autovalidateMode != AutovalidateMode.disabled
                            ? (field.hasError
                            ? effectiveDecoration.errorBorder
                            : effectiveDecoration.enabledBorder)
                            : effectiveDecoration.enabledBorder,
                        focusedBorder: autovalidateMode != AutovalidateMode.disabled
                            ? (field.hasError
                            ? effectiveDecoration.errorBorder
                            : effectiveDecoration.focusedBorder)
                            : effectiveDecoration.focusedBorder,
                        disabledBorder: autovalidateMode != AutovalidateMode.disabled
                            ? (field.hasError
                            ? effectiveDecoration.errorBorder
                    ...
                    Padding(
                        padding: EdgeInsets.only(left: contentPadding != null ? contentPadding.horizontal/2 : 20.0),
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            autovalidateMode != AutovalidateMode.disabled ? (field.hasError ? field.errorText! : '') : '',
                            overflow: TextOverflow.ellipsis,
                            maxLines: 1,
                            style: effectiveDecoration.errorStyle != null
                                ? effectiveDecoration.errorStyle
                                ?.copyWith(color: Theme.of(field.context).colorScheme.error)
                                : Theme.of(field.context).textTheme.caption!.copyWith(
