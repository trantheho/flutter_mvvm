...
class MyFlexibleSpaceBar extends StatefulWidget {
  ...
  /// Defines how much the title is scaled when the MyFlexibleSpaceBar is expanded
  ...
  ///
  final TitleTransformAlignment? titleTransformAlignment;
  ...
  /// See also:
  ///
  ///  * [MyFlexibleSpaceBarSettings] which creates a settings object that can be
...
class _MyFlexibleSpaceBarState extends State<MyFlexibleSpaceBar> {
  ...
  Alignment _getTitleAlignment(bool effectiveCenterTitle) {
    if (widget.titleTransformAlignment != null) {
      switch (widget.titleTransformAlignment!) {
        case TitleTransformAlignment.center:
          return Alignment.bottomCenter;
        case TitleTransformAlignment.bottomLeft:
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        final double t =
            clampDouble(1.0 - (settings.currentExtent - settings.minExtent) / deltaExtent, 0.0, 1.0);
        ...
        if (widget.titleBuilder != null) {
          ...
          switch (theme.platform) {
            case TargetPlatform.iOS:
            case TargetPlatform.macOS:
              title = widget.titleBuilder!(settings, constraints, t);
              break;
            case TargetPlatform.android:
            case TargetPlatform.fuchsia:
            case TargetPlatform.linux:
            case TargetPlatform.windows:
              title = Semantics(
                namesRoute: true,
                child: widget.titleBuilder!(settings, constraints, t),
              );
              break;
          }
...
typedef TitleBuilder = Widget Function(FlexibleSpaceBarSettings settings, BoxConstraints constraints, double t);
