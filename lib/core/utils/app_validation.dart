...
class _Validator {
  ...
  PhoneValidationState validatePhoneNumber(String? phone) {
    if (phone == null) {
      return PhoneValidationState.badPhoneNumber;
    } else if (phone.isEmpty) {
      return PhoneValidationState.badPhoneNumber;
  ...
  PasswordValidationState validateName(String? stringName, int length) {
    if (stringName == null || stringName.isEmpty || stringName == '') {
      return PasswordValidationState.badPassword;
